...
╰━━━┻╯╰┻╯╰━┻╯╰╯
""")
webbrowser.open("https://t.me/justpython1")
...
print(Z1+"------------••--•-••••••----------")
print(X+"by DarkZone")
print("ex : http://google.com/")
print("or")
print("https://google.com/")
print(Z1+"---------------------------------")
url = input(A+"WEBSITE ===»: ")

skill = ('admin/','administrator/','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
for jall in skill:
	gg = url+jall
	try:
		op = urllib.request.urlopen(gg)
		print(F+"•••••••••••••••••••••••••••••••••••")
		print(X+"∆∆ ADMIN PAGE FOUND ∆∆ : "+gg)
		print(F+"••••••••••••••••••••••••••••••••••••")
	except urllib.error.URLError as no:
		print(Z+"××××××××××××××××××××××")
		print(Z1+"༺  NOT FOUND   ༻ : "+gg)
		print(Z+"××××××××××××××××××××××")

print(C+"I WISH YOU FOUND TARGET ♡")